...
export const appRoutes = [...hotelRoutes, ...listingRoutes, ...flightsRoutes, ...toursRoutes, ...cabsRoutes, ...directoriesRoutes, ...heroRoutes, ...listingPagesRoutes, ...aboutUsRoutes, ...contactUsRoutes, ...blogsRoutes, ...otherRoutes];