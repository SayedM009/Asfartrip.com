      ...
      <Col lg={6}>
        <Card className="bg-primary p-4">
          <div className="d-flex justify-content-between align-items-start text-white">
            ...
            <Dropdown>
              <DropdownToggle as={Link} to="" className="arrow-none text-white" id="creditcardDropdown" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
