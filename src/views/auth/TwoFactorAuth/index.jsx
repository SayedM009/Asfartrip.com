...
const OTPInput = ({
  ...
  return <input id={id} name={id} type="text" className="form-control text-center p-3" value={value} maxLength={1} onChange={e => onValueChange(id, e.target.value)} onKeyUp={handleKeyUp} />;
};
const TwoFactorAuth = () => {
