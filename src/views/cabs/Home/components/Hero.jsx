                        ...
                        <Row className="g-2 g-md-4">
                          ...
                          <Col md={6}>
                            <div className="form-fs-lg form-control-transparent">
                              ...
                              <DatePicker className="form-control flatpickr" placeholder="Select Date" options={{
                              dateFormat: 'd M'
                            }} />
                            </div>
                          </Col>
                          <Col md={6} className="text-md-end">
                            <div className="form-fs-lg form-control-transparent">
                              ...
                              <DatePicker className="form-control flatpickr text-md-end" placeholder="Select Date" options={{
                              enableTime: true,
                              noCalendar: true,
                              dateFormat: 'h:i K'
                            }} />
                      ...
                      <TabPane eventKey="2" className={clsx('fade', activeTab === 'round-trip' && 'show active')} id="cab2-round-way" role="tabpanel" aria-labelledby="cab2-round-way-tab">
                        <Row className="g-2 g-md-4">
                          ...
                          <Col sm={6} className="text-sm-end">
                            <div className="form-fs-lg form-control-transparent">
                              <label className="form-label small ms-3 ms-md-0 me-md-3">Pickup time</label>
                              <DatePicker className="form-control flatpickr text-md-end" options={{
                              enableTime: true,
                              noCalendar: true,
                              dateFormat: 'h:i K'
