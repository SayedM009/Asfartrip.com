                  ...
                  <Row className="g-4">
                    ...
                    <Col lg={4}>
                      <div className="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                        ...
                        <DatePicker options={{
                        dateFormat: 'd M Y'
                      }} defaultValue={new Date().toDateString()} className="form-control flatpickr" />
                      </div>
                    </Col>
                  ...
                  <Row className="g-4">
                    ...
                    <Col md={6} xl={3}>
                      <div className="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                        ...
                        <DatePicker defaultValue={new Date().toDateString()} options={{
                        dateFormat: 'd M Y'
                    ...
                    <Col md={6} xl={3}>
                      <div className="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                        ...
                        <DatePicker defaultValue={new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toDateString()} options={{
                        dateFormat: 'd M Y'
                      }} className="form-control flatpickr" />
                      </div>
                    </Col>
