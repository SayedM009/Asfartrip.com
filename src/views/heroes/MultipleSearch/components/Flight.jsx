        ...
        <div className="tab-content" id="pills-tabContent">
            ...
            <Row className="g-4">
              ...
              <Col md={6}>
                <div className="form-icon-input form-fs-lg">
                  <DatePicker className="form-control form-control-lg flatpickr" placeholder="Select check-in date" options={{
                  dateFormat: 'd M y'
                }} />
                  <span className="form-icon">
                    <div>
              ...
              <Col md={6}>
                <div className="form-icon-input form-fs-lg">
                  <Dropdown className="guest-selector">
                    <DropdownToggle as="input" className="arrow-none form-guest-selector form-control form-control-lg selection-result" placeholder="Select occupant" value={getGuestsValue()} />
          ...
          <div className={clsx('tab-pane fade', activeTab === 'round-trip' && 'show active')}>
            <Row className="g-4">
              ...
              <Col md={4}>
                <div className="form-icon-input form-fs-lg">
                  <DatePicker className="form-control form-control-lg flatpickr" options={{
                  dateFormat: 'd M y'
