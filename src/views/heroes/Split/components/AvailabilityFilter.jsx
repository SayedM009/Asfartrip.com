            ...
            <form className="row g-4">
              ...
              <Col md={6}>
                ...
                <div className="form-border-bottom form-control-transparent d-flex align-items-center">
                  ...
                  <div className="form-fs-lg">
                    <DatePicker className="form-control flatpickr" options={{
                    dateFormat: 'd M Y'
                ...
                <div className="form-border-bottom form-control-transparent d-flex align-items-center">
                  ...
                  <div className="form-fs-lg">
                    <Dropdown className="guest-selector me-2">
                      <DropdownToggle as="input" className="arrow-none form-guest-selector form-control form-fs-lg selection-result" placeholder="Select occupant" value={getGuestsValue()} />
