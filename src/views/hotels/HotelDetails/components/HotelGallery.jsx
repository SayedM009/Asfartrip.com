              ...
              <div className="d-lg-flex justify-content-lg-between mb-1">
                ...
                <ul className="list-inline text-end">
                  ...
                  <Dropdown className="list-inline-item dropdown">
                    <DropdownToggle className="btn btn-sm btn-light px-2 arrow-none" role="button" id="dropdownShare" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <Row className="g-2">
                <Col xs={12}>
                  <GlightBox data-glightbox data-gallery="gallery" image={gallery13}>
                    <Card className="card-grid-sm card-element-hover card-overlay-hover overflow-hidden" style={{
                ...
                <Col md={6}>
                  <GlightBox data-glightbox data-gallery="gallery" image={gallery12}>
                    ...
                    backgroundSize: 'cover'
                      ...
                      <div className="hover-element position-absolute w-100 h-100">
                        <BsFullscreen size={28} className="bifs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1" />
                      </div>
                    </Card>
                  </GlightBox>
                </Col>
                <Col md={6}>
                  <Card className="card-grid-sm overflow-hidden" style={{
