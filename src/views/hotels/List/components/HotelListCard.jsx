  ...
  return <Card className="shadow p-2">
      <Row className="g-0">
        <Col md={5} className="position-relative">
          {sale && <div className="position-absolute top-0 start-0 z-index-1 m-2">
          ...
          <CardBody className="py-md-2 d-flex flex-column h-100 position-relative">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <ul className="list-inline mb-0 z-index-2">
                ...
                <Dropdown className="list-inline-item dropdown">
                  <DropdownToggle className="arrow-none btn btn-sm btn-light btn-round" role="button" id="dropdownShare" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul className="list-group list-group-borderless small mb-0 mt-2">
              {schemes ? <Fragment>
                ...
                return <li key={idx} className="list-group-item d-flex text-success p-0 items-center">
                        <BsPatchCheckFill className="me-2" />
                        {scheme}
                      </li>;
              })}
                </Fragment> : <li className="list-group-item d-flex text-danger p-0 items-center">
                  <BsPatchCheckFill className="me-2" />
                  Non Refundable
                </li>}
            </ul>
