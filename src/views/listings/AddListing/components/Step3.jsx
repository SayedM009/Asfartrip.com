      ...
      <CardBody>
        <Row className="g-4">
          <Col xs={12}>
            ...
            <ReactQuill value={listingPolicyDescription} onChange={setListingPolicyDescription} modules={{
            toolbar: [[{
...
const Step3 = ({
  ...
  return <div id="step-3" role="tabpanel" className="content fade" aria-labelledby="steppertrigger3">
