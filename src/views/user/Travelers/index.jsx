        ...
        <CardBody className="card-body vstack gap-4">
          <Card>
            ...
            <form className="card-body p-0 pt-3">
              ...
              <div>
                ...
                <DatePicker type="text" className="form-control flatpickr" defaultValue="29 Aug 1996" placeholder="Enter date of birth" options={{
                dateFormat: 'd M Y'
              }} />
              </div>
            </form>
          ...
          <Card>
            ...
            <form className="card-body p-0 pt-3">
              ...
              <div>
                <label className="form-label">Date of Birth</label>
                <DatePicker type="text" className="form-control flatpickr" defaultValue="15 May 1994" placeholder="Enter date of birth" options={{
                dateFormat: 'd M Y'
              }} />
              </div>
            </form>
      ...
      <Modal show={isOpen} onHide={toggle} className="fade">
        ...
        <ModalBody className="p-3">
          <form>
            ...
            <div className="mb-3">
              <label className="form-label">Date of Birth</label>
              <DatePicker type="text" className="form-control flatpickr" options={{
              dateFormat: 'd M y'
            }} />
